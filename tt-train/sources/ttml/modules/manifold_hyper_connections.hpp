...
// sum, broadcast_to, reshape, permute, matmul_op) with no new kernels.
...
private:
    autograd::TensorPtr compute_static(const autograd::TensorPtr& x);
    autograd::TensorPtr compute_dynamic(const autograd::TensorPtr& x);
